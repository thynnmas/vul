...
v2 vec2( f32 x, f32 y ) { v2 r; r.x = x; r.y = y; return r; }
v3 vec3( f32 x, f32 y, f32 z ) { v3 r; r.x = x; r.y = y; r.z = z; return r; }
v4 vec4( f32 x, f32 y, f32 z, f32 w ) { v4 r; r.x = x; r.y = y; r.z = z; r.w = w; return r; }

f32 vdot2( v2 a, v2 b) { return a.x * b.x + a.y * b.y; }
f32 vdot3( v3 a, v3 b) { return a.x * b.x + a.y * b.y + a.z * b.z; }
f32 vdot4( v4 a, v4 b) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }

f32 vnorm2( v2 v ) { return sqrtf( vdot2( v, v ) ); }
f32 vnorm3( v3 v ) { return sqrtf( vdot3( v, v ) ); }
f32 vnorm4( v4 v ) { return sqrtf( vdot4( v, v ) ); }

v2 vnormalize2( v2 v ) { return vmuls2( v, 1.f / vnorm2( v ) ); }
v3 vnormalize3( v3 v ) { return vmuls3( v, 1.f / vnorm3( v ) ); }
v4 vnormalize4( v4 v ) { return vmuls4( v, 1.f / vnorm4( v ) ); }
...
v2 vclamp2( v2 v, f32 a, f32 b ) {
	v2 r;
	r.x = v.x < a ? a : v.x > b ? b : v.x;
	r.y = v.y < a ? a : v.y > b ? b : v.y;
	return r;
}
v3 vclamp3( v3 v, f32 a, f32 b ) {
	v3 r;
	r.x = v.x < a ? a : v.x > b ? b : v.x;
	r.y = v.y < a ? a : v.y > b ? b : v.y;
...
f32 mdeterminant44( m44 m ) {
	...
	for( word i = 0; i < 4; ++i ) {
		...
		det += powf( -1.f, i ) * mdeterminant33( a );
	}
	return det;
}

m22 minverse22( m22 m ) {
	m22 r;
